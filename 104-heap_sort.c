...
/**
 * swap -the utility function to swap to integers
 * @a:the integer a
 * @b:the integer b
 **/
...
/**
 * maxHeapify -  main function to heapify a Max Heap. The function
...
/**
 * heap_sort - main function to sort an array of given size
