...
#include <stdio.h>
/**
 * swap -its change two values in ascending or descending order
 * @arr: array
 * @item1: item one
 * @item2: item two
...
/**
 * merge -the sort bitonic sequences recursively in both orders
 * @arr: array
...
/**
 * bitonic_sort -its prepare the terrain to bitonic sort algorithm
 * @array:the array
