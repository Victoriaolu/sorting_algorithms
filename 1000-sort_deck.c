...
#include <stdio.h>
/**
 *_strcmp -its compare two strings
 *@str1:the string
 *@str2:the string
...
/**
 * get_card_position -its return the position based on card you put in
 * @node:its represent the card
...
/**
 *swap_card -its swap a card for his previous one
 *@card:the card
 *@deck:the card deck
...
/**
 * insertion_sort_deck -the function that sorts a doubly linked deck
...
/**
 * sort_deck -its sort a deck you put in using
