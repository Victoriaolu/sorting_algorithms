...
#include <stdio.h>
/**
 *_calloc - it is a calloc function
...
/**
 *merge -its make a merge
 *@arr: one from start to mid
 *@tmp:the temp array used in merge, was created outside to
...
/**
 *merge_sort -the function that sorts an array of integers
 *in ascending order using the Merge sort algorithm
